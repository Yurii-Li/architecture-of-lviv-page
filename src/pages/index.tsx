          ...
          <div className={styles.architecturalItems}>
            <div className={styles.architecturalItem}>
              <div className={styles.architecturalDesc}>
                <p>
                  Величний храм у Львові – собор святого Юра – це не тільки один
                  з найгарніших храмів нашого міста, а й одна з найцікавіших
                  архітектурних пам’яток. Це – монументальний архітектурний
                  ансамбль з виразними національними рисами, який тривалий час
                  вважався головною святинею українських греко-католиків. Так
                  було аж до появи в столиці Патріаршого собору Воскресіння
                  Христового, однак велич храму і далі зберігає святість
                  особливого місця.
                </p>
                <p>
              ...
              <div className={styles.architecturalImage}>
                <Image
                  ...
                  fill
                  sizes="(min-width: 1340px) 600px, (min-width: 560px) 46.18vw, calc(76.67vw - 175px)"
                />
              </div>
            </div>
            ...
            <div className={styles.architecturalItem}>
              <div className={styles.architecturalImage}>
                <Image
                  ...
                  alt="Собор святого Юра"
                  fill
                  sizes="(min-width: 1340px) 600px, (min-width: 560px) 46.18vw, calc(75vw - 166px)"
                />
              </div>
              <div className={styles.architecturalDesc}>
                <p>
                  Ще одна архітектурна пам’ятка нашого міста – це церква святого
                  Андрія, храм, який більше знаний для львів’ян як Костел та
                  монастир бернандинів. Це – греко-католицька культова споруда,
            ...
            <div className={styles.architecturalItem}>
              <div className={styles.architecturalDesc}>
                <p>
                  Домініканський собор – це найбільший бароковий храм на
            ...
            <div className={styles.architecturalItem}>
              ...
              <div className={styles.architecturalDesc}>
                <p>
                  Церква святих Ольги і Єлизавети у Львові – ще одна цікава
                  архітектурна пам’ятка, чинна неоготична церква українських
                  греко-католиків на площі Кропивницького. Храм було зведено в
                  честь знаної історичної особистості – імператриці Єлизавети
                  Баварської, яка була дружиною цісаря Астро-Угорщини
                  Франца-Йосифа І.
                </p>
                <p>
            ...
            <div className={styles.architecturalItem}>
              <div className={styles.architecturalDesc}>
                <p>
                  Оперний театр в нашому місті – ще одна архітектурна гордість,
                  яку було зведено на початку 20-го століття. Це один з
                  найгарніших оперних театрів Європи, будівля, зведена в стилі
                  неоренесансу.
                </p>
                <p>
